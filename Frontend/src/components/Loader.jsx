...
/**
 * Full SVG loader (ring + ticks + arrows). Use everywhere a loading state is shown.
 * @param {string} size - "sm" (button), "md" (inline), "lg" (full page)
 */
export default function Loader({ size = "lg", className = "" }) {
  ...
  return (
    <div className={`${styles.pl} ${sizeClass} ${className}`.trim()}>
      <svg
        className="pl"
        viewBox="0 0 160 160"
        width="160px"
      ...
      >
        ...
        <g>
          <g className={styles.plRingRotate}>
            <circle
              className={styles.plRingStroke}
              cx={80}
              cy={80}
              r={72}
              fill="none"
        ...
        <g>
          <g transform="translate(64,28)">
            <g className={styles.plArrows} transform="rotate(45,16,52)">
              <path
                fill="hsl(3,90%,55%)"
