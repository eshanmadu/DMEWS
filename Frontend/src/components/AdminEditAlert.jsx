...
export function AdminEditAlert({ alertId }) {
      ...
      try {
        ...
        if (!cancelled) {
          setForm({
            ...
            expectedEndTime: toDateTimeLocal(data?.expectedEndTime),
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">
          Update disaster type, severity, time range, instructions, and status.
        </p>
      </div>
      ...
      <section className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm">
        <div className="flex items-center gap-2 border-b border-slate-100 bg-slate-50/80 px-4 py-3">
          ...
          <h2 className="text-sm font-semibold text-slate-800">Update disaster alert</h2>
          <p className="text-xs text-slate-500">Modify warning details and save changes.</p>
        </div>
            ...
            <div className="space-y-1.5 md:col-span-2">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  placeholder="Describe the disaster situation and warning details"
                  className="w-full rounded-xl border border-slate-300 bg-white py-2.5 pl-10 pr-3 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-amber-500 focus:ring-2 focus:ring-amber-200"
                />
              </div>
